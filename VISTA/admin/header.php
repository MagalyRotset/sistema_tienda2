...
<nav class="navbar navbar-expand-lg">
  ...
  ?>
    <div class="navbar-nav ml-auto ">
      ...
      <li class="nav-item-i">
        <a class="nav-link" href="inventario_admin.php">Inventario</a>
      </li>
      ...
      <ul class="nav-item-i">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="general_anual.php">Anual</a>
              <a class="dropdown-item" href="general_trimestral.php">Trimestral</a>
              <a class="dropdown-item" href="general_mensual.php">Mensual</a>
            </div>
        </div>       
      </ul>
      ...
      <ul class="nav-item-i">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="departamento_anual.php">Anual</a>
              <a class="dropdown-item" href="departamento_trimestral.php">Trimestral</a>
              <a class="dropdown-item" href="departamento_mensual.php".php">Mensual</a></div>
        </div>       
      </ul>
