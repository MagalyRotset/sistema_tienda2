...
<ul class="navbar-nav ml-auto ">
      ...
      <ul class="nav-item-i">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="../admin/general_anual.php">Anual</a>
              <a class="dropdown-item" href="../admin/general_trimestral.php">Trimestral</a>
              <a class="dropdown-item" href="../admin/general_mensual.php">Mensual</a>
            </div>
        </div>       
      </ul>
      ...
      <ul class="nav-item-i">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="departamento_anual.php">Anual</a>
              <a class="dropdown-item" href="departamento_trimestral.php">Trimestral</a>
              <a class="dropdown-item" href="departamento_mensual.php".php">Mensual</a>
            </div>
        </div>       
      </ul>
...
<?php
  if($_SESSION["tipo_usuario"] == 3 ){
    ...
    <li class="nav-item-i">
      <a class="nav-link" href="inventario_general">Inventario</a>
    </li>
      ...
      <ul class="nav-item-i">
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="../admin/departamento_anual.php">Anual</a>
              <a class="dropdown-item" href="../admin/departamento_trimestral.php">Trimestral</a>
              <a class="dropdown-item" href="../admin/departamento_mensual.php">Mensual</a>
            </div>
        </div>       
      </ul>
    </ul>
